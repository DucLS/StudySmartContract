...
describe("ERC20 gold token", () => {
    ...
    let token;
    let amount = ethers.utils.parseUints("100", "ether");
    let address0 = "0x0000000000000000000000000000000000000000"
    let totalSupply = ethers.utils.parseUints("1000000", "ether");
    ...
    describe('common', () => {
        ...
        it('balance of accountC should return right value', async () => {
